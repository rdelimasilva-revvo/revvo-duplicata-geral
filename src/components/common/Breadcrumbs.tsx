...
const routeLabelMap: Record<string, string> = {
  ...
  'receivables-home': 'Início',
  'receivables-notas-fiscais': 'Notas Fiscais',
  'receivables-liquidations': 'Controle de Liquidações',
  'receivables-sacados': 'Cadastro de Sacados',
  ...
  'agente-intermediador/oneracao': 'Agente de oneração',
  'automacoes': 'Automações',
  'payment-report': 'Relatório de Pagamentos',
  'profiles-access': 'Perfis e Acessos',
  'ocultar-menus': 'Ocultar menus',
  'meu-perfil': 'Meu Perfil',
  'settings': 'Configurações',
  'integrations-status': 'Status integrações',
};

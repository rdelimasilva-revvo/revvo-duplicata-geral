...
import { mockDomicileRequests } from '@/modules/gestorDomicilio/data/mockDomicileRequests';
import { DomicileRequestDetails } from '@/modules/gestorDomicilio/components/domicile/DomicileRequestDetails';
import { NewDomicileRequestForm } from '@/modules/gestorDomicilio/components/domicile/NewDomicileRequestForm';
              ...
              <tbody>
                {requests.map((request) => (
                  <tr key={request.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <span className="capitalize">{request.approvalLevel}</span>
                    </td>
                    <td className="px-4 py-3">

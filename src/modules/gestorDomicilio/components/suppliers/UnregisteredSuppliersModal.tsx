...
import { mockUnregisteredSuppliers, mockRegistrationRequests } from '@/modules/gestorDomicilio/data/mockUnregisteredSuppliers';
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-4">
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${getRiskColor(selectedSupplier.riskLevel)}`}>
                  Risco: {selectedSupplier.riskLevel.toUpperCase()}
                </span>

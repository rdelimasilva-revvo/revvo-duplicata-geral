    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-lg w-[700px] p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div>
              ...
              <p className="text-sm">R$ {billData.value.toFixed(2)}</p>
            </div>
            <div>
          ...
          <div>
            ...
            >
              ...
              <option value="lei5474">Lei 5.474/68 - Art. 8º</option>
              <option value="lei13775">Lei 13.775/18 - Art. 3º</option>
              <option value="decreto9311">Decreto 9.311/18</option>
              <option value="outras">Outras disposições legais</option>
            </select>
          </div>
          <div>
            <label className="block text-sm text-gray-600 mb-1">
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <Button 
            variant="primary" 
            onClick={() => onConfirm(reason, `${description}${legalBasis ? ` | Base legal: ${legalBasis}` : ''}`)}
